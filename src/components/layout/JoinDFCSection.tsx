  ...
  const features = [
    {
      ...
      description: 'Receive payments instantly after each consultation or procedure. No delays, no hassles.'
    },
    {
      title: 'Premium Facilities',
      description: 'Access world-class medical facilities with the latest equipment and dedicated support staff.'
    },
    {
      title: 'Flexible Scheduling',
      description: 'Set your own schedule and availability. Work when it suits you best.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              <p className="">
                Our platform handles everything so you can focus on what matters most - healing.
              </p>
            </div>
