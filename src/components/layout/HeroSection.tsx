      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 md:pt-60 pb-24 text-center z-20">
        <div className={`animate-text-reveal ${mounted ? 'visible' : ''}`}>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-white">
            Get World-Class Medical Care<br />Right Here in Nigeria
          </h1>
        </div>

        <div className={`animate-text-reveal ${mounted ? 'visible' : ''}`} style={{ animationDelay: '200ms' }}>
          <p className="mt-6 max-w-3xl mx-auto text-lg text-gray-200">
            Book consultations and surgeries with top diaspora doctors visiting Nigeria.
            Premium facilities, international expertise, local convenience.
          </p>
        </div>

        {/* Search Bar */}
        <div className="mt-10 max-w-2xl mx-auto">
          <div className={`animate-fade-up ${mounted ? 'visible' : ''}`} style={{ animationDelay: '400ms' }}>
