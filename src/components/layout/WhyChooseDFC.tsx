  ...
  return (
    <section className="text-primary py-16 sm:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ref={titleRef}
          className={`text-center animate-fade-up ${titleVisible ? "visible" : ""}`}
        >
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <p className="mt-2 text-muted-light dark:text-muted-dark text-sm">
              Access diaspora doctors with international training and
              experience, now practicing in Nigeria.
            </p>
          </div>
          ...
          >
            ...
            <p className="mt-2 text-sm">
              Book appointments in minutes, not months. Get the care you need
              when you need it.
            </p>
          ...
          >
            ...
            <p className="mt-2 text-sm">
              Premium healthcare at local prices. No need for expensive medical
              tourism.
            </p>
          </div>
        </div>
