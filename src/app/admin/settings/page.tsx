          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSettings("notifications", "appointments", checked)
                }
              />
            </div>
          </CardContent>
          ...
          <CardContent className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateSettings("security", "passwordPolicy", e.target.value)
                }
                rows={3}
              />
            </div>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) =>
                  updateSettings("system", "registrationOpen", checked)
                }
              />
            </div>
            <div className="flex items-center justify-between">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  updateSettings("system", "backupTime", e.target.value)
                }
              />
            </div>
          </CardContent>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input 
                  id="consultationFee" 
                  type="number" 
                  value={settings.payment.consultationFee}
                  onChange={(e) => updateSettings("payment", "consultationFee", parseFloat(e.target.value) || 0)}
                  placeholder="5,000"
                />
                <p className="text-sm text-gray-500 mt-1">
                  Current: ₦{settings.payment.consultationFee.toLocaleString()}
                </p>
              </div>
              <div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input 
                  id="replyEmail" 
                  value={settings.email.replyEmail}
                  onChange={(e) => updateSettings("email", "replyEmail", e.target.value)}
                />
              </div>
              <div className="flex items-center justify-between">
                <div>
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => updateSettings("email", "enableSSL", checked)}
                />
              </div>
            </div>
          </div>
